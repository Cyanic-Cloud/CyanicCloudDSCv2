...
```
New-CsTeamsAudioConferencingPolicy [[-Identity] <Object>] [-AllowTollFreeDialin <Object>] [-Force] [-InMemory]
 [-MeetingInvitePhoneNumbers <Object>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
