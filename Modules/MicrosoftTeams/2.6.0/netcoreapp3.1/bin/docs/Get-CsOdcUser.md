...
online version: https://docs.microsoft.com/en-us/powershell/module/Teams/get-csodcuser
schema: 2.0.0
---
...
### Get (Default)
```
Get-CsOdcUser -Identity <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CsOdcUser -InputObject <IConfigApiBasedCmdletsIdentity> [<CommonParameters>]
```
