...
online version: https://docs.microsoft.com/en-us/powershell/module/Teams/remove-csteamsshiftsconnectionteammap
schema: 2.0.0
---
...
### Remove (Default)
```
Remove-CsTeamsShiftsConnectionTeamMap -ConnectorInstanceId <String> -TeamId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-CsTeamsShiftsConnectionTeamMap -InputObject <IConfigApiBasedCmdletsIdentity> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
...
Unlinks the Teams team and WFM team
